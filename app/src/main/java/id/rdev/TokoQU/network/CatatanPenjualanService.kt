package id.rdev.TokoQU.network

import id.rdev.TokoQU.activity.data_barang.data.ResultDataBarang
import id.rdev.TokoQU.activity.login.data.ResultLogin
import id.rdev.TokoQU.activity.penjualan.data.ResultKeranjang
import id.rdev.TokoQU.activity.penjualan.data.ResultSearchBarang
import id.rdev.TokoQU.activity.report.detail.data.ResultItemKeranjang
import id.rdev.TokoQU.response.ResultSimple
